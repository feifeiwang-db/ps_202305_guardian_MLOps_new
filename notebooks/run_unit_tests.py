...
notebook_path = dbutils.notebook.entry_point.getDbutils().notebook().getContext().notebookPath().get() #/Repos/feifei.wang@databricks.com/test_software_best_practice_20230502/notebooks/run_unit_tests
repo_root = os.path.dirname(os.path.dirname(notebook_path)) #/Repos/feifei.wang@databricks.com/test_software_best_practice_20230502
